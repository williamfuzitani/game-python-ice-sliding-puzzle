...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        self.player_sprite.boundary_right = SPRITE_SIZE * 8
        self.player_sprite.boundary_left = SPRITE_SIZE * 3
        self.player_sprite.boundary_top = SPRITE_SIZE
        self.player_sprite.boundary_bottom = SPRITE_SIZE * 3
    ...
    def update(self, delta_time):
        ...
        for player in self.player_list:
            if len(arcade.check_for_collision_with_list(player, self.collision_list)) > 0:
                self.player_sprite.change_x = 0
                self.player_sprite.change_y = 0
